...
- [2. A 2D map game with a flashlight](#2-a-2d-map-game-with-a-flashlight)
	...
	- [$Interseption_y$ first step](#y_intercept-first-step)
	- [$Interseption_x$ first step](#x_intercept-first-step)
	- [Get Next Step](#get-next-step)
	- [Get $Interseption_y$ next step](#get-y_intercept-next-step)
	- [Get $Interseption_x$ next step](#get-x_intercept-next-step)
