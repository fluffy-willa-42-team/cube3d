...
/*   Updated: 2022/11/23 17:09:26 by awillems         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	if (	!init_texture(&game.temp,		0 | ALLOW_CLIP,		"./texture/mc/grass_side.xpm42",					0x0000FFFF)
		...
		||	!init_texture(&game.t_cont1,	0,					"./texture/cont/container_big_side_l.xpm42", 		0xaaaaaaff)
		||	!init_texture(&game.t_cont2,	0,					"./texture/cont/container_big_side_r.xpm42", 		0xaaaaaaff)
		||	!init_texture(&game.t_cont3,	0,					"./texture/cont/container_big_side_m.xpm42", 		0xaaaaaaff)
		||	!init_texture(&game.t_cont4,	0,					"./texture/cont/container_small_side.xpm42", 		0xaaaaaaff)
		||	!init_texture(&game.t_cont5,	0,					"./texture/cont/container_open.xpm42", 				0xaaaaaaff)
