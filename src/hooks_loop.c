...
void	hook_loop(void *param)
{
	...
	if (mlx_is_key_down(game->param.mlx, KEY_ESCAPE))		mlx_close_window(game->param.mlx);
	...
	if (mlx_is_key_down(game->param.mlx, KEY_LEFT))			angle_hook(game, -0.05);
	if (mlx_is_key_down(game->param.mlx, KEY_RIGHT))			angle_hook(game, 0.05);
	if (mlx_is_key_down(game->param.mlx, KEY_KP_4))			angle_hook(game, -0.05);
	if (mlx_is_key_down(game->param.mlx, KEY_KP_6))			angle_hook(game, 0.05);
	if (mlx_is_key_down(game->param.mlx, KEY_KP_1))			angle_hook(game, -0.01);
	if (mlx_is_key_down(game->param.mlx, KEY_KP_3))			angle_hook(game, 0.01);
